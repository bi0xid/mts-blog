...
<tr><td width="100%" height="10"></td></tr>
<tr><td width="100%"><a href="http://www.idevlibrary.com/docs/Lightboxes.pdf" target="_blank"><b>{$lb_head_tutorial}</b></a></td></tr>
<tr><td width="100%" height="10"></td></tr>
</table>
</td></tr>
</table>
...
<a href="lightboxes/{$lightbox_link_results[nr].lightbox_image}" width="{$lightbox_link_results[nr].lightbox_main_width}" height="{$lightbox_link_results[nr].lightbox_main_height}" title="{$lightbox_link_text}" rev="{$lightbox_link_results[nr].lightbox_link}" rel="{$lb_rel_values}lightbox">
...
<textarea rows="5" cols="65">{$lightbox_link_results[nr].lightbox_code}</textarea>
<BR /><BR />
</td></tr>
</table>
</td>
...
{$lb_body_click}<BR /><BR />
{$lb_body_source_code}<BR />
<textarea rows="5" cols="65">{$lightbox_link_results[nr].lightbox_code}</textarea><BR /><BR />
