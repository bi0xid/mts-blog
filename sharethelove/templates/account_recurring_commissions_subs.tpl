...
<td width="20%" align="right">{if $cur_sym_location == 1}{$cur_sym}{/if}{$recurring_list_results[nr].recurring_results_amount}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}&nbsp; </td>
</tr>
...
<td width="20%" bgcolor="{$light_cells}" align="right"><font color="{$red_text}"><b>{if $cur_sym_location == 1}{$cur_sym}{/if}{$recurring_total_amount}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}</b></font>&nbsp; </td>
</tr>
