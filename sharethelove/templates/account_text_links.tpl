...
<textarea rows="3" cols="56"><a href="{$textlink_link_results[nr].textlink_link_url}" target="_blank"{$tl_rel_values}>{$textlink_link_results[nr].textlink_link_text}</a></textarea><BR /><BR />
</td>
</tr>
</table>
</td>
