...
<td width="35%" align="right">{if $cur_sym_location == 1}{$cur_sym}{/if}{$payment_results[nr].payment_amount}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}&nbsp; </td>
...
<td width="35%" height="25" bgcolor="{$light_cells}" align="right"><font color="{$red_text}"><b>{if $cur_sym_location == 1}{$cur_sym}{/if}{$payments_archived}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}</b></font>&nbsp; </td>
