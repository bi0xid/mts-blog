...
<table border="0" cellpadding="1" cellspacing="1" width="100%">
<tr>
<td width="100%" bgcolor="{$table_top}">&nbsp;<b><font color="{$section_head_txt}">General Preferences</font></b></td>
</tr>
<tr>
...
<tr><td width="100%" colspan="2" height="10"></td></tr>
    <tr>
      <td width="25%">&nbsp;Language To Receive Email</td><td width="75%">{include file='file:account_edit_email_preferences.tpl'}</td>
    </tr>
<tr><td width="100%" colspan="2" height="10"></td></tr>
</table>
</table>
