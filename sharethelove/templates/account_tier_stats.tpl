...
<td width="35%" align="center" bgcolor="{$white_back}"><a href="account.php?page=12"><font color="{$page_links}">{$tier_stats_grab_link}</font></a></td>
</tr>
</table>
</td>
</tr>
...
<table border="0" cellpadding="1" cellspacing="1" width="100%">
<tr>
<td width="100%" colspan="4" bgcolor="{$table_top}">&nbsp;<b><font color="{$section_head_txt}">{$tier_stats_accounts}</font></b></td>
</tr>
...
<td width="30%" align="right">{if $cur_sym_location == 1}{$cur_sym}{/if}{$tier_results[nr].tier_current_payments}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}&nbsp; </td>
<td width="25%" align="right">{if $cur_sym_location == 1}{$cur_sym}{/if}{$tier_results[nr].tier_archived_payments}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}&nbsp; </td>
<td width="25%" align="right"><b>{if $cur_sym_location == 1}{$cur_sym}{/if}{$tier_results[nr].tier_total_payments}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}&nbsp; </b></td>
</tr>
...
<td width="25%" bgcolor="{$light_cells}" align="right"><b>{if $cur_sym_location == 1}{$cur_sym}{/if}{$tier_summary_current_payments}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}</b>&nbsp; </td>
<td width="25%" bgcolor="{$light_cells}" align="right"><b>{if $cur_sym_location == 1}{$cur_sym}{/if}{$tier_summary_archived_payments}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}</b>&nbsp; </td>
<td width="25%" bgcolor="{$light_cells}" align="right"><font color="{$red_text}"><b>{if $cur_sym_location == 1}{$cur_sym}{/if}{$tier_summary_total_payments}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency}</b></font>&nbsp; </td>
</tr>
*}
{else}
