...
<select size="1" name="email_language" style="width:140px;">
...
// ----------------------------------
$default_email_language = mysql_query("select email_override from idevaff_affiliates where username = '" . $_SESSION['idev_LoggedUsername'] . "'");
