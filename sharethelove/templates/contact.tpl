...
<tr><td width="100%" colspan="3"><font color="{$red_text}"><b>{$error_title}</b></font><br />{$error_list}<br /></td></tr>
{/if}

<tr height="25">
<td width="25%">{$contact_name_display}:</td>
<td width="75%" colspan="2"><input type="text" name="name" size="30" value="{$contact_name}"></td>
</tr>
<tr height="25">
<td width="25%">{$contact_email_display}:</td>
<td width="75%" colspan="2"><input type="text" name="email" size="30" value="{$contact_email}"></td>
</tr>
<tr>
<td width="25%">{$contact_message_display}:</td>
...
<tr>
<td width="25%">{$signup_security_code}:</td>
...
<tr>
<td width="25%"></td>
<td width="75%" colspan="2"><font color="{$red_text}">{$contact_received_display}</font></td>
</tr>
...
<tr>
<td width="25%"></td>
<td width="75%" colspan="2"><input type="submit" value="{$contact_button_display}"></td></form>
</tr>
