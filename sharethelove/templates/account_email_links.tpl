...
{$email_html}
<BR />&nbsp;
<textarea rows="3" cols="56"><a href="{$email_chosen_url}{$rel_values}">{$email_chosen_group_name}</a></textarea>
<BR />&nbsp;
{$email_source}
<BR /><BR />&nbsp;
<b>{$email_test}</b>: <a href="{$email_chosen_url}{$rel_values}" target="_blank">{$email_chosen_display_tag}</a>
<BR />&nbsp;
{$email_test_info}
<BR />
<BR />
