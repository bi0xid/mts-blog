...
var itemStyles = [
    ["itemWidth=144px","itemHeight=20px","itemBackImage=templates/menus/images/cold.png,templates/menus/images/hot.png","itemBorderWidth=0","fontStyle='normal 11px sans-serif','normal 11px sans-serif'","fontColor=#000000,#000000"],
];
var menuStyles = [
...
var menuItems = [
    ...
    ["{$menu_drop_heading_commissions}","account.php?page=4&report=1", "", "", "{$menu_drop_heading_commissions}", "_self", "0", "0", "", "", "", ],
			...
			["|{$menu_drop_delayed}","account.php?page=4&report=6", "", "", "{$menu_drop_delayed}", "_self", "", "", "", "", "", ],
			{/if}
    ...
    ["{$menu_drop_heading_account}","account.php?page=17", "", "", "{$menu_drop_heading_account}", "_self", "0", "0", "", "", "", ],
			...
			["|{$testi_title}","account.php?page=41", "", "", "Offer A Testimonial", "_self", "", "", "", "", "", ],
			{/if}
