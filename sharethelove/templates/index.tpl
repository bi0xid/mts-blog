...
<tr><td width="25%" bgcolor="{$lighter_cells}">&nbsp;&nbsp;&nbsp;{$index_table_sale}:</td><td width="75%" bgcolor="{$lighter_cells}">&nbsp;{if $cur_sym_location == 1}{$cur_sym}{/if}{$bot2}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency} {$index_table_sale_text}</td></tr>
{/if}

{if isset($choose_perclick_payout)}
<tr><td width="25%" bgcolor="{$lighter_cells}">&nbsp;&nbsp;&nbsp;{$index_table_click}:</td><td width="75%" bgcolor="{$lighter_cells}">&nbsp;{if $cur_sym_location == 1}{$cur_sym}{/if}{$bot3}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency} {$index_table_click_text}</td></tr>
{/if}
...
<tr><td bgcolor="{$lighter_cells}" width="25%"><b>&nbsp;{$index_table_initial_deposit}</b></td><td width="75%" bgcolor="{$lighter_cells}">&nbsp;{if $cur_sym_location == 1}{$cur_sym}{/if}{$init_deposit}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency} - <font color="#CC0000"><b>{$index_table_deposit_tag}</b></font></td></tr>
{/if}

{if isset($add_requirements_row)}
<tr><td bgcolor="{$lighter_cells}" width="25%"><b>&nbsp;{$index_table_requirements}</b></td><td width="75%" bgcolor="{$lighter_cells}">&nbsp;{if $cur_sym_location == 1}{$cur_sym}{/if}{$init_req}{if $cur_sym_location == 2} {$cur_sym}{/if} {$currency} - {$index_table_requirements_tag}</td></tr>
{/if}
