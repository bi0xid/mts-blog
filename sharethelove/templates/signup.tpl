...
{/if}
    ...
    <tr>
      ...
      <td width="50%" bgcolor="{$lighter_cells}" colspan="2">&nbsp;<img src="images/help.gif" title="header=[{$signup_login_username} & {$signup_login_password}] body=[{$signup_login_minmax_chars}]" style="cursor:pointer;">
	</td>
    </tr>
    <tr>
      ...
      <td width="50%" bgcolor="{$lighter_cells}" colspan="2">&nbsp;<img src="images/help.gif" title="header=[{$signup_login_username} & {$signup_login_password}] body=[{$signup_login_minmax_chars}]" style="cursor:pointer;"></td>
    </tr>
    <tr>
