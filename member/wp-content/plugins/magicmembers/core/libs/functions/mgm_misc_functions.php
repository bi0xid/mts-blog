...
function mgm_filter_cc_details($data=NULL){
	//skip card fields
	$_cc_filter_arr = array('ACCT','CVV2','CREDITCARDTYPE','mgm_card_number','number','x_card_num');
	
	$_cc_filter_str = array('<RebillCCNumber>.+?<\/RebillCCNumber>'=>'<RebillCCNumber>************</RebillCCNumber>',
