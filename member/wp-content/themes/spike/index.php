			...
			<div id="content_box">
				...
				if ( is_home() ) { ?>
					...
					foreach($custom_posts as $key => $post) : setup_postdata($post); ?>
						...
						<!-- the advert -->
						<?php if( $key == 1 ) { ?>
							<div id="WFItem502138" class="wf-formTpl hidden-mailform">
								...
								method="post">
												...
												<li class="wf-email" rel="undefined" style="display:  block !important; ">
													<div class="wf-contbox">
														...
														<div class="wf-inputpos">
															...
															data-placeholder="yes" value="Enter Your E-Mail Here"></input>
														</div>
														<em class="clearfix clearer"></em>
													</div>
												</li>
									...
									<input type="hidden" name="webform_id" value="502138" />
								</form>
							</div>
							<script type="text/javascript" src="http://app.getresponse.com/view_webform.js?wid=502138&mg_param1=1"></script>
							<script type="text/javascript" src="http://app.getresponse.com/view_webform.js?wid=502138&mg_param1=1"></script>
						<?php } ?>
