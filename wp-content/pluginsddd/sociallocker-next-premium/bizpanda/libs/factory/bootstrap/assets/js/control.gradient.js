( function( $ ){
    ...
    $.fn.factoryBootstrap328_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap328_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-328 .factory-gradient").factoryBootstrap328_gradientControl();
    });
