	...
	GradientSelection.prototype = {    
		...
		this.g2d = canvas.getContext("2d");
            ...
            _createColorPicker: function() {
                ...
                this.$colorPicker.factoryBootstrap328_iris({
                    width: 217,
                ...
                self.$colorHex.on('change paste keyup', function(){
                    ...
                    self.$colorPicker.factoryBootstrap328_iris('color', self.$colorHex.val());
		...
		this.$el.append( this.$directionDropdown );  
            ...
            showColorPicker: function( point ) {
                ...
                this.$colorPicker.factoryBootstrap328_iris( 'show' );
                this.$colorPicker.factoryBootstrap328_iris( 'option', 'color', point.color );
