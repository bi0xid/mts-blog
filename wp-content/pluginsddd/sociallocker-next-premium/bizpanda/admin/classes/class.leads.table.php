    ...
    public function no_items() {
        ...
        if ( BizPanda::isSinglePlugin() ) {
            ...
            if ( BizPanda::hasPlugin('optinpanda') ) {
                ...
                printf('To start generating leads, create <a href="%s"><strong>Sign-In Locker</strong></a> and lock with them some content on your website.', opanda_get_help_url('what-is-signin-locker'));
            }
