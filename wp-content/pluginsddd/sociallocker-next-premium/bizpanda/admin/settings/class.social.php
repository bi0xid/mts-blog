...
class OPanda_SocialSettings extends OPanda_Settings  {
    ...
    public function header() {
        ?>
        <p><?php _e('Set up here your social API keys and app IDs for the connect and social buttons.', 'optionpanda') ?></p>
        <?php
    }
    ...
    public function getOptions() {
        ...
        $options[] = array(
            ...
            'data'      => $languages,
            'hint'      => __( 'Select the language that will be used for the social buttons in the social lockers.', 'optinpanda' )
        );
        ...
        $options[] = array(
            ...
            'hint'      =>  sprintf( __( 'By default, the developer app id is set. If you want to use the Facebook Share or Facebook Connect buttons you need to <a href="%s">register another app</a> id for your website.', 'optinpanda' ), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=facebook-app') ),
        ...
        $options[] = array(
            ...
            'hint'      => sprintf( __( 'The Twitter Connect button requires a Twitter App. We prepared one for you by default. But if you worry about security, you can <a href="%s">create an own app</a>. Also by creating your own Twitter app you will be able to change the title, description and image for the "Sign In" popup window.', 'optinpanda' ), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=twitter-app') )
        );
        ...
        $options[] = array(
            ...
            'hint'      => sprintf( __( 'If you want to use the Google Connect button, please <a href="%s">create a Client ID</a> for your website.', 'optinpanda' ), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=google-client-id') )
        );  
        ...
        $options[] = array(
            ...
            'hint'      => sprintf( __( 'If you want to use the LinkedIn Connect button, please <a href="%s">get a API Key</a> for your website.', 'optinpanda' ), admin_url('admin.php?page=how-to-use-' . $this->plugin->pluginName . '&onp_sl_page=linkedin-api-key') )
        );
