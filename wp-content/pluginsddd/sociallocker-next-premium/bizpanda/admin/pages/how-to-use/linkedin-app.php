...
<div class="onp-help-section">
    <p><?php printf( __('7. Copy & paste your API Key on the page Global Settings > <a href="%s">Social Options</a>.', 'optinpanda' ), admin_url('admin.php?page=settings-optinpanda&opanda_screen=social') ) ?></p>
</div>