<div class="wrap">
    ...
    <h2><?php echo 'Advertising block-Add Image'?></h2>
    <div class="clear"></div>
    <form action="" method="post" id="ws_form_add">
        ...
        <table cellspacing="0" class="wp-list-taxonomy">
            ...
            <tr>
                ...
                <td><input type="text" name="url" id="url" class="required" value="<?php echo isset($form->url)? $form->url : '';?>"> </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    jQuery('.custom_media_url').focus(function(e) {
        ...
        var custom_uploader = wp.media({
            title: 'Upload Image for Advertising block',
            button: {
                text: 'Submit'
            },
