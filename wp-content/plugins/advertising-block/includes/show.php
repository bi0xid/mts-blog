<div class="wrap">
    ...
    <h2><?php echo 'Advertising block'?></h2>
    ...
    <form action="" method="post" id="ws_form">
        ...
        <table class="table table-striped table-bordered table-condensed albu   mList">
            ...
            <?php
                $iDefaultImage = get_option('default_image_for_addvertising', 0); 
            ?>
            ...
            <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php if($val->id != $iDefaultImage): ?>
                            <a class="btn btn-small btn-inverse" href="?page=<?php echo $_GET['page']?>&action=set_default&id=<?php echo $val->id?>">Set as default</a>
                        <?php endif; ?>
