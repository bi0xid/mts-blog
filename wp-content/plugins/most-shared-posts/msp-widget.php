	...
	function widget( $args, $instance ) {
		...
		while ( $posts_in_range->have_posts() ) : $posts_in_range->the_post();
			...
			if (!$suppress_icons)
			{
                ...
                echo "<span id='most_shared_post_gl'><span class='shared_icons'></span></span>" . $plusones;
				...
				*/
				...
				if ($include_fb_count)
				{
                    echo "<span id='most_shared_post_fb' class='shared_icons_wrapper'><span class='shared_icons'></span></span>" . $fb_likes;
				}
