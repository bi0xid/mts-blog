...
class OnpSL_StatisticsPage extends FactoryPages320_AdminPage  {
    ...
    ?>
        ...
        <div class="wrap">
            ...
            <div id="onp-sl-chart-selector">
                ...
                <?php ?>
                <div class="onp-sl-chart-item facebook-share">
                    <span class="chart-color"></span>
                    <?php _e('FB Shares', 'sociallocker') ?>
                </div>
                <?php 
 ?>
                ...
                <?php ?>
                <div class="onp-sl-chart-item twitter-follow">
                    <span class="chart-color"></span>
                    <?php _e('Twitter Followers', 'sociallocker') ?>
                </div>
                <?php 
 ?>
                ...
                <?php ?>
                <div class="onp-sl-chart-item google-share">
                    <span class="chart-color"></span>
                    <?php _e('Google Shares', 'sociallocker') ?>
                </div>
                <div class="onp-sl-chart-item linkedin-share">
                    <span class="chart-color"></span>
 ...
 ?>
            ...
            <table id="onp-sl-posts">
                <thead>
                    ...
                    <?php ?>
                    <th class="col-number col-facebook-share"><?php _e('FB Shares', 'sociallocker') ?></th> 
                    <?php 
 ?>
                    <th class="col-number col-twitter-tweet"><?php _e('Tweets', 'sociallocker') ?></th>  
                    <?php ?>
                    <th class="col-number col-twitter-follow"><?php _e('Twitter Follower', 'sociallocker') ?></th>
                    <?php 
 ?>
 ...
 ?>
                ...
                <tr>
                    ...
                    <?php ?>
                    <td class="col-number col-facebook-share"><?php echo $dataRow['facebook_share_count'] ?></td>
                    <?php 
 ?>
                    <td class="col-number col-twitter-tweet"><?php echo $dataRow['twitter_tweet_count'] ?></td>
                    <?php ?>
                    <td class="col-number col-twitter-follow"><?php echo $dataRow['twitter_follow_count'] ?></td>   
                    <?php 
 ?>
