        ...
        if ( $this->_pages !== false ) return $this->_pages;
            ...
            $items = array(
                ...
                array(
                    ...
                    'title' => __('Have a plugin review?', 'sociallocker')
                ),
                array(
    ...
    public function gettingStarted() {
        ...
        ?>
            ...
            <div class="onp-help-section">
                ...
                <p>1) <?php _e('Set a clear title that attracts attention or calls to action (see the example below).', 'sociallocker'); ?></p>
                <p>2) <?php _e('Describe that a visitor will get after unlocking.<br /> It\'s a very important point. Visitors need to realize that they will get. And that should be truth.', 'sociallocker'); ?></p> 
                <p>3) <?php _e('Choose one of the available themes for your locker.', 'sociallocker'); ?></p>
                </p>

                <p class='onp-img'>
                    <img src='<?php echo ONP_SL_PLUGIN_URL . '/assets/admin/img/how-to-use/3.png' ?>' />
                </p>
                ...
                <p class='onp-img'>
                    <img src='<?php echo ONP_SL_PLUGIN_URL . '/assets/admin/img/how-to-use/4.png' ?>' />
                </p>
