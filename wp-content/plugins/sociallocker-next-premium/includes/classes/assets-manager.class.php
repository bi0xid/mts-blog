            ...
            $params = array(
                ...
                'facebook' => array(
                    ...
                    'like' => array(
                        ...
                        'theConfirmIssue' => self::getLockerOption($id, 'facebook_like_confirm_issue' )
                    ),
                    'share' => array(
                        'url' => $fbShareUrl,
                        'counter' => self::getLockerOption($id, 'facebook_share_counter_url' ),
                        'title' => self::getLockerOption($id, 'facebook_share_title' ),
                        'name' => self::getLockerOption($id, 'facebook_share_message_name' ),
                        'caption' => self::getLockerOption($id, 'facebook_share_message_caption' ),
                        'description' => self::getLockerOption($id, 'facebook_share_message_description' ),
                        'image' => self::getLockerOption($id, 'facebook_share_message_image' )
                    ),
                ),
                'twitter' => array(
                    ...
                    'tweet' => array(
                        'url' => $twTweetUrl,
                        'text' => self::getLockerOption($id, 'twitter_tweet_text' ),
                        'counturl' => self::getLockerOption($id, 'twitter_tweet_counturl' ),
                        'title' => self::getLockerOption($id, 'twitter_tweet_title' ),
                        'via' => self::getLockerOption($id, 'twitter_tweet_via' )
                    ),
                    'follow' => array(
                        'url' => $twFollowUrl,
                        'title' => self::getLockerOption($id, 'twitter_follow_title' ) 
                    )
                ),  
                'google' => array(   
                    ...
                    'plus' => array(
                        'url' => $glPlusUrl,
                        'title' => self::getLockerOption($id, 'google_plus_title' ) 
                    ),
                    'share' => array(
                        'url' => $glShareUrl,
                        'title' => self::getLockerOption($id, 'google_share_title' ) 
                    ),
                ),  
                'linkedin' => array(   
                    'share' => array(
                        'url' => $lnShareUrl,
                        'title' => self::getLockerOption($id, 'linkedin_share_title' ) 
                    ),
                )
            );
