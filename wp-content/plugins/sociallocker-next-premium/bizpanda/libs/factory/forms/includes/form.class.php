...
add_action('factory_forms_327_plugin_created', 'factory_forms_327_plugin_created');
function factory_forms_327_plugin_created( $plugin ) {
    $plugin->forms = new FactoryForms327_Manager( $plugin );
}

class FactoryForms327_Manager {
     ...
     * 
     * @see FactoryForms327_Form::registerControl()
     * 
     * @since 1.0.0
     * @return void
     */
     ...
     * 
     * @see FactoryForms327_Form::registerHolder()
     * 
     * @since 1.0.0
     * @return void
     */
     ...
     * 
     * @see FactoryForms327_Form::registerCustomElement()
     * 
     * @since 1.0.0
     * @return void
     */
...
class FactoryForms327_Form {
     ...
     * 
     * @since 1.0.0
     * @var FactoryForms327_FormLayout 
     */
    public $layout;
    ...
    public function __construct( $options = array(), $plugin = null ) {
        ...
        if ( !FactoryForms327_Manager::$controlsRegistered ) {
            do_action('factory_forms_327_register_controls', $plugin);
            ...
            FactoryForms327_Manager::$controlsRegistered = true;
        }
        ...
        if ( !FactoryForms327_Manager::$temper ) FactoryForms327_Manager::$temper = $isFlat ? 'flat' : 'volumetric';
    }
     ...
     * 
     * @since 1.0.0
     * @param IFactoryForms327_ValueProvider $provider
     * @return void
     */
    ...
    public function createControl( $item ) {
        ...
        if ( is_array( $item ) ) {
            ...
            $controlData = FactoryForms327_Manager::$registeredControls[$item['type']];
     ...
     * @since 1.0.0
     * @param type $item Item data.
     * @return FactoryForms327_Holder A control holder object.
     */
    public function createHolder( $item ) {
        ...
        if ( is_array( $item ) ) {
            ...
            $holderData = FactoryForms327_Manager::$registeredHolders[$item['type']];
     ...
     * @since 1.0.0
     * @param type $item Item data.
     * @return FactoryForms327_FormElement A custom form element object.
     */
    public function createCustomElement( $item ) {
        ...
        if ( is_array( $item ) ) {
            ...
            $data = FactoryForms327_Manager::$registeredCustomElements[$item['type']];
    ...
    public function html( $options = array() ) {
        ...
        if ( !isset( FactoryForms327_Manager::$formLayouts[$this->formLayout] ) )
            die( sprintf( '[ERROR] The form layout %s was not found.', $this->formLayout ) ); 
        
        // include a render code
        $layoutData = FactoryForms327_Manager::$formLayouts[$this->formLayout];
    ...
    public static function connectAssetsForItem( $item ) {
        ...
        $haystack = array();
        if ( self::isControl($type) ) $haystack = FactoryForms327_Manager::$registerControls;
        elseif ( self::isControlHolder($type) ) $haystack = FactoryForms327_Manager::$registeredHolders;
    ...
    public static function isControl( $item ) {
        return isset( FactoryForms327_Manager::$registeredControls[ $item['type'] ] );
    }
    ...
    public static function isControlHolder( $item ) {
        return isset( FactoryForms327_Manager::$registeredHolders[ $item['type'] ] );
    } 
    ...
    public static function isCustomElement( $item ) {
        return isset( FactoryForms327_Manager::$registeredCustomElements[ $item['type'] ] );
    }
}