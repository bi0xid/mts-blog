 ...
 * @since 1.0.0
 */
class FactoryForms327_FormHelpers {
    ...
    public static function render( $type, $options = array() ) {
        ...
        if ( FactoryForms327_Form::isControl($type) ) {
            self::renderControl($type, $options);
        } elseif ( FactoryForms327_Form::isControlHolder($type) ) {
    ...
    public static function renderControl($type, $options) {
        FactoryForms327_Form::connectAssetsForItem( $options );
