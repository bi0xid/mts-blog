...
class FactoryForms327_GradientControl extends FactoryForms327_Control 
{
    ...
    public function html( ) {
      ...
      <script>
          ...
          factory.res.resVertical = '<?php _e( 'vertical', 'factory_forms_327' ) ?>';
          factory.res.resHorizontal = '<?php _e( 'horizontal', 'factory_forms_327' ) ?>';
      </script>
      <div <?php $this->attrs() ?>>
