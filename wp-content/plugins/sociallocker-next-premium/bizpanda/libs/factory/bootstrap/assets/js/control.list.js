( function( $ ){
    ...
    $.fn.factoryBootstrap328_listControl = function (option) {
    ...
    $.fn.factoryBootstrap328_listControl.Constructor = list;

    $(function(){
        $(".factory-bootstrap-328 .factory-list").factoryBootstrap328_listControl();
    });
