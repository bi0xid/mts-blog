...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap328.colorControl", {
        ...
        _init: function( event ) {
            ...
            this.$picker.factoryBootstrap328_iris(irisOptions); 
            this.$picker.off('focus');

            $(document).on("click.color.factory", function(){
               self.$picker.factoryBootstrap328_iris("hide");  
            });

            this.$picker.add(this.$background).on("click.color.factory", function(e){
               e.stopPropagation();
               self.$picker.factoryBootstrap328_iris("show");  
            });  
        },
        ...
        hidePicker: function() {
            ...
            this.$picker.factoryBootstrap328_iris( 'hide' );
        }, 

        showPicker: function() {
            this.$element.addClass('factory-picker-active');
            this.$picker.factoryBootstrap328_iris( 'show' );
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap328_colorControl", $.factoryBootstrap328.colorControl );
        $(".factory-bootstrap-328 .factory-color").factoryBootstrap328_colorControl({});
    });
