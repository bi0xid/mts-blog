( function( $ ){
    ...
    $.fn.factoryBootstrap328_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap328_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-328 .factory-paddings-editor").factoryBootstrap328_paddingsEditor();
    });
