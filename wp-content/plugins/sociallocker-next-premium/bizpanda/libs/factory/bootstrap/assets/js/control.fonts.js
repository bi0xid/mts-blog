...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap328.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap328_fontControl", $.factoryBootstrap328.fontControl );
        $(".factory-bootstrap-328 .factory-font").factoryBootstrap328_fontControl({});
    });
