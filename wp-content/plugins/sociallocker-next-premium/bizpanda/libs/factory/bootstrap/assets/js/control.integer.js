( function( $ ){
    ...
    $.fn.factoryBootstrap328_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap328_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-328 .factory-integer").factoryBootstrap328_integerControl();
    });
