( function( $ ){
    ...
    $.fn.factoryBootstrap328_checkboxControl = function (option) {
    ...
    $.fn.factoryBootstrap328_checkboxControl.Constructor = CheckboxControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-328 .factory-checkbox.factory-buttons-way").factoryBootstrap328_checkboxControl();
    });
