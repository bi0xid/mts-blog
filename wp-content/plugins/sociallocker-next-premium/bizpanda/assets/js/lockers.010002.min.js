/*!
 * Panda Lockers - v1.0.1, 2015-02-09 
...
(function ($) {
    ...
    */
    ...
    $.pandalocker.lang = {
        ...
        byClickingYouAreAgreeWith:          'By clicking on the button(s), you agree with ',
        termsAndConditions:                 'Terms of Use',
        privacyPolicy:                      'Privacy Policy',
        
        dataProcessingText:                 'Processing data, please wait...',
        ...
        scopes: {
            ...
            signinLocker: {
                ...
                viaFacebookLong:    "Sign in via Facebook",
                viaTwitterLong:     "Sign in via Twitter",
                viaGoogleLong:      "Sign in via Google",
                viaLinkedInLong:    "Sign in via LinkedIn",
                
                viaFacebookShort:   "via Facebook",
                viaTwitterShort:    "via Twitter",
                viaGoogleShort:     "via Google",
                viaLinkedInShort:   "via LinkedIn"
            },
            ...
            emailLocker: {
                ...
                viaFacebookLong:    "via Facebook",
                viaTwitterLong:     "via Twitter",
                viaGoogleLong:      "via Google",
                viaLinkedInLong:    "via LinkedIn",
                
                viaFacebookShort:   "Facebook",
                viaTwitterShort:    "Twitter",
                viaGoogleShort:     "Google",
                viaLinkedInShort:   "LinkedIn"
            },
            ...
            socialLocker: {
                ...
                viaFacebookLong:    "Subscribe via Facebook",
                viaTwitterLong:     "Subscribe via Twitter",
                viaGoogleLong:      "Subscribe via Google",
                viaLinkedInLong:    "Subscribe via LinkedIn",
        ...
        connectButtons: {
            ...
            facebook: {
                notConnected: "Sorry, but you have not signed in. Please try again.",
                notAllPermissionsGranted: "Sorry, but you have not granted all the required permissions ({0}). Please try again. <a href='#' class='onp-sl-policy'>Click here</a> to know why we need these permissions."
            },
            ...
            oneStepToComplete: 'One Step To Complete',
            enterYourEmail: 'Please enter your email below to continue.',
            doneComplete: 'Finish Registration',
        ...
        subscription: {
            ...
            orEnterYourEmailManually: 'or enter your email manually to sign in',
            
            canceled: "You have canceled your subscription.",
            
            errorEmptyEmail: "Please enter your email address.",
            errorIncorrectEmail: "It seems you entered an incorrect email address. Please check it.",
            errorEmptyName: "Please enter your name.",            
            
            waitingConfirmationHeader: 'Please Confirm Your Email',
            waitingConfirmationText1: 'We have sent a confirmation email to {0}. Please click on the confirmation link in the email to reveal the content.',
            waitingConfirmationText2: 'The content will be unlocked automatically within {1} seconds after confirmation.',    
            waitingConfirmationText3: 'Note delivering the email may take several minutes.',
            
            checkEmailBox: 'Open my inbox on {0}',
            cancelWaitingButtonText: '(cancel)',
 ...
 * @pacakge includes
*/
!function(a){"use strict";a.pandalocker||(a.pandalocker={}),a.pandalocker.data||(a.pandalocker.data={}),a.pandalocker.class||(a.pandalocker.class={}),a.pandalocker.groups||(a.pandalocker.groups={}),a.pandalocker.controls||(a.pandalocker.controls={}),a.pandalocker.tools||(a.pandalocker.tools={}),a.pandalocker.storages||(a.pandalocker.storages={}),a.pandalocker.services||(a.pandalocker.services={}),a.pandalocker.extras||(a.pandalocker.extras={}),a.pandalocker.controls["social-buttons"]||(a.pandalocker.controls["social-buttons"]={}),a.pandalocker.controls["connect-buttons"]||(a.pandalocker.controls["connect-buttons"]={}),a.pandalocker.controls.subscription||(a.pandalocker.controls.subscription={})}(jQuery);;
/*!
 * Filers & Hooks API
 * Copyright 2014, OnePress, http://byonepress.com
 * 
 ...
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.socialButton);b.name="facebook-like",b._defaults={url:null,layout:"button_count",width:"auto",verbToDisplay:"like",colorScheme:"light",font:"tahoma",ref:null,theConfirmIssue:!1},b.prepareOptions=function(){this.url=this._extractUrl(),"vertical"===this.groupOptions.layout?this.options.layout="box_count":this.groupOptions.counters||(this.options.layout="button")},b.setupHooks=function(){var a=this;this.addHook("markup-created",function(){a._startTrackIFrameSizes()}),this.addHook("before-show-content",function(){a._stopTrackIFrameSizes()})},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-facebook-like",function(a,c){b.url===URL.normalize(c)&&b.unlock("button")})},b.renderButton=function(b){this.button=a("<div></div>").appendTo(b),this.button.attr("data-show-faces",!1),this.button.attr("data-send",!1),this.button.attr("data-href",this.url),this.options.font&&this.button.attr("data-font",this.options.font),this.options.colorScheme&&this.button.attr("data-colorscheme",this.options.colorScheme),this.options.ref&&this.button.attr("data-ref",this.options.ref),this.options.width&&this.button.attr("data-width",this.options.width),this.options.layout&&this.button.attr("data-layout",this.options.layout),this.options.verbToDisplay&&this.button.attr("data-action",this.options.verbToDisplay),this.button.addClass("fb-like"),window.FB.XFBML.parse(b[0])},b._startTrackIFrameSizes=function(){if(!this.options.theConfirmIssue){var b=this;this._trackIFrameTimer=null,this.locker.locker.hover(function(){var c=b.control.find("iframe");c.length&&(b._trackIFrameTimer=setInterval(function(){var d=parseInt(c[0].style.height);d||(d=c.height()),d>200&&(b._stopTrackIFrameSizes(),a(document).trigger("onp-sl-facebook-like",[b.url]))},500))},function(){b._stopTrackIFrameSizes()})}},b._stopTrackIFrameSizes=function(){this._trackIFrameTimer&&clearInterval(this._trackIFrameTimer)},a.pandalocker.controls["social-buttons"]["facebook-like"]=b}(jQuery);;
/*!
 * Facebook Share Button
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.socialButton);b.name="facebook-share",b._defaults={url:null,layout:"button_count",count:"standard",lang:"en_US",width:"auto",name:null,caption:null,description:null,image:null,unlock:null},b.prepareOptions=function(){return this.url=this._extractUrl(),this.options.appId?void("vertical"===this.groupOptions.layout?this.options.layout="box_count":this.groupOptions.counters||(this.options.layout="button")):(this.showError(a.pandalocker.lang.errors.emptyFBAppIdError),!1)},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-facebook-share",function(a,c){b.url===URL.normalize(c)&&b.unlock("button")})},b.renderButton=function(b){var c=this;this.button=a("<div></div>").appendTo(b),this.button.attr("data-href",this.url),this.options.width&&this.button.attr("data-width",this.options.width),this.options.layout&&(this.button.attr("data-layout",this.options.layout),this.button.attr("data-type",this.options.layout));var d=a("<div class='onp-sl-facebook-share-overlay'></div>").appendTo(b);d.click(function(){return FB.ui({method:"feed",name:c.options.name,link:c.url,picture:c.options.image,caption:c.options.caption,description:c.options.description},function(b){b&&b.post_id&&a(document).trigger("onp-sl-facebook-share",[c.url])}),!1}),this.button.addClass("fb-share-button"),window.FB.XFBML.parse(b[0])},a.pandalocker.controls["social-buttons"]["facebook-share"]=b}(jQuery);;
/*!
 * Twitter Tweet
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.socialButton);b.name="twitter-tweet",b._defaults={url:null,text:null,via:null,related:null,count:"horizontal",lang:"en",counturl:null,size:"medium"},b.prepareOptions=function(){if(!this.options.url&&!this.networkOptions.url&&a("link[rel='canonical']").length>0&&(this.options.url=a("link[rel='canonical']").attr("href")),this.url=this._extractUrl(),"vertical"===this.groupOptions.layout?this.options.count="vertical":this.groupOptions.counters||(this.options.count="none"),this.groupOptions.lang){var b=this.groupOptions.lang.split("_");this.groupOptions.lang=b[0]}},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-twitter-tweet",function(c,d){if(d&&d.target){var e=URL.normalize(a(d.target).parent().data("url-to-verify"));b.url===URL.normalize(e)&&b.unlock("button")}})},b.renderButton=function(b){var c=this;this.button=a('<a href="https://twitter.com/share" class="twitter-share-button">Tweet</a>').appendTo(b),this.button.attr("data-url",this.url),this.button.attr("data-show-count",this.options.showCount),this.options.via&&this.button.attr("data-via",this.options.via),this.options.text&&this.button.attr("data-text",this.options.text),this.options.related&&this.button.attr("data-related",this.options.related),this.options.count&&this.button.attr("data-count",this.options.count),this.options.lang&&this.button.attr("data-lang",this.options.lang),this.options.counturl&&this.button.attr("data-counturl",this.options.counturl),this.options.hashtags&&this.button.attr("data-hashtags",this.options.hashtags),this.options.alignment&&this.button.attr("data-alignment",this.options.alignment),this.options.size&&this.button.attr("data-size",this.options.size),this.options.dnt&&this.button.attr("data-dnt",this.options.dnt),b.data("url-to-verify",c.url);var d=5,e=function(){if(!(b.find("iframe").length>0))if(window.twttr.widgets&&window.twttr.widgets.load)window.twttr.widgets.load(b[0]);else{if(0>=d)return;d--,setTimeout(function(){e()},1e3)}};e()},a.pandalocker.controls["social-buttons"]["twitter-tweet"]=b}(jQuery);;
/*!
 * Twitter Follow
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.socialButton);b.name="twitter-follow",b._defaults={url:null,showScreenName:!1,showCount:!0,lang:"en",size:"medium"},b.prepareOptions=function(){if(!this.options.url||-1===this.options.url.indexOf("twitter"))return this.showError(a.pandalocker.lang.errors.emptyTwitterFollowUrlError),!1;if(this.url=this._extractUrl(),"vertical"===this.groupOptions.layout?this.showError(a.pandalocker.lang.errors.unsupportedTwitterFollowLayout):this.groupOptions.counters||(this.options.showCount=!1),this.groupOptions.lang){var b=this.groupOptions.lang.split("_");this.groupOptions.lang=b[0]}},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-twitter-follow",function(c,d){if(d&&d.target){var e=URL.normalize(a(d.target).parent().data("url-to-verify"));b.url===URL.normalize(e)&&b.unlock("button")}})},b.renderButton=function(b){var c=this;this.button=a('<a href="https://twitter.com/share" class="twitter-follow-button">Follow</a>').appendTo(b),this.button.attr("href",this.url),this.button.attr("data-show-count",this.options.showCount),this.options.showCount&&this.button.attr("data-show-count",this.options.showCount),this.options.lang&&this.button.attr("data-lang",this.options.lang),this.options.alignment&&this.button.attr("data-alignment",this.options.alignment),this.options.size&&this.button.attr("data-size",this.options.size),this.options.dnt&&this.button.attr("data-dnt",this.options.dnt),this.options.showScreenName&&this.button.attr("data-show-screen-name",this.options.showScreenName),b.data("url-to-verify",c.url);var d=5,e=function(){if(!(b.find("iframe").length>0))if(window.twttr.widgets&&window.twttr.widgets.load)window.twttr.widgets.load(b[0]);else{if(0>=d)return;d--,setTimeout(function(){e()},1e3)}};e()},a.pandalocker.controls["social-buttons"]["twitter-follow"]=b}(jQuery);;
/*!
 * Google +1
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.socialButton);b.name="google-plus",b._defaults={url:null,lang:"en-US",size:"medium",annotation:null,width:null,align:"left",expandTo:"",recommendations:!0},b.prepareOptions=function(){this.url=this._extractUrl(),"vertical"===this.groupOptions.layout?this.options.size="tall":this.groupOptions.counters||(this.options.annotation="none")},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-google-plus",function(a,c){b.url===URL.normalize(c)&&b.unlock("button")})},b.renderButton=function(b){this.button=a("<div></div>").appendTo(b),this.button.attr("data-href",this.url),this.options.size&&this.button.attr("data-size",this.options.size),this.options.annotation&&this.button.attr("data-annotation",this.options.annotation),this.options.align&&this.button.attr("data-align",this.options.align),this.options.expandTo&&this.button.attr("data-expandTo",this.options.expandTo),this.options.recommendations&&this.button.attr("data-recommendations",this.options.recommendations),this.button.attr("data-callback","OPanda_GooglePlusOne_Callback"),this.button.addClass("g-plusone"),setTimeout(function(){window.gapi.plusone.go(b[0])},100)},a.pandalocker.controls["social-buttons"]["google-plus"]=b}(jQuery);;
/*!
 * Google Share
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=Object.create(a.pandalocker.class.socialButton);b.name="google-share",b._defaults={url:null,lang:"en-US",size:null,annotation:"bubble",width:null,align:"left",expandTo:"",recommendations:!0},b.prepareOptions=function(){this.url=this._extractUrl(),"vertical"===this.groupOptions.layout?this.options.annotation="vertical-bubble":this.groupOptions.counters||(this.options.annotation="none")},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-google-share-opened",function(c,d){b.url===URL.normalize(d)&&(b._maxPopupHeight=0,b._heightChecker=setInterval(function(){var c=a(".goog-bubble-content").height();c>b._maxPopupHeight&&(b._maxPopupHeight=c)},300))}),a(document).bind("onp-sl-google-share-closed",function(a,c){b.url===URL.normalize(c)&&(b._maxPopupHeight>350&&b.unlock("button"),b._heightChecker&&clearInterval(b._heightChecker),b._heightChecker=null)})},b.renderButton=function(b){this.button=a("<div></div>").appendTo(b),this.button.attr("data-href",this.url),this.options.size&&this.button.attr("data-size",this.options.size),this.options.annotation&&this.button.attr("data-annotation",this.options.annotation),this.options.align&&this.button.attr("data-align",this.options.align),this.options.expandTo&&this.button.attr("data-expandTo",this.options.expandTo),this.options.recommendations&&this.button.attr("data-recommendations",this.options.recommendations),this.button.attr("data-onstartinteraction","OPanda_GoogleShare_StartInteraction"),this.button.attr("data-onendinteraction","OPanda_GoogleShare_EndInteraction"),this.button.addClass("g-plus").attr("data-action","share"),setTimeout(function(){window.gapi.plus.go(b[0])},100)},a.pandalocker.controls["social-buttons"]["google-share"]=b}(jQuery);;
/*!
 * LinkedIn Share
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.socialButton);b.name="linkedin-share",b.verification.container=".IN-widget",b.verification.timeout=5e3,b._defaults={url:null,counter:"right"},b.prepareOptions=function(){this.url=this._extractUrl(),"vertical"===this.groupOptions.layout?this.options.counter="top":this.groupOptions.counters||(this.options.counter="none")},b.setupEvents=function(){var b=this;a(document).bind("onp-sl-linkedin-share",function(a,c){b.url===URL.normalize(c)&&b.unlock("button")})},b.renderButton=function(b){var c=this;this.button=a('<script type="IN/Share" data-onsuccess="OPanda_LinkedinShare_Callback" data-success="OPanda_LinkedinShare_Callback" data-onSuccess="OPanda_LinkedinShare_Callback"></script>'),this.options.counter&&this.button.attr("data-counter",this.options.counter),this.button.attr("data-url",this.url),this.button.appendTo(b),IN.init(),IN.parse&&IN.parse(this.button[0]),b.click(function(){setTimeout(function(){if(a.pandalocker.sdk.linkedin._activePopup){var b=a.pandalocker.sdk.linkedin._activePopup;a.pandalocker.sdk.linkedin._activePopup=!1;var d=setInterval(function(){b&&b.closed===!1||(clearInterval(d),a(document).trigger("onp-sl-linkedin-share",[c.url]))},200)}},200)})},a.pandalocker.controls["social-buttons"]["linkedin-share"]=b}(jQuery);;
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.group);b._defaults={order:["facebook","twitter","google"],facebook:{version:"v1.0"},twitter:{},google:{},linkedin:{}},b.name="connect-buttons",b.setup=function(){this.isFirst||(this.options.text.message=this.options.text.message||a.pandalocker.lang.connectButtons.defaultMessage,this.options.text.message=a.pandalocker.tools.normilizeHtmlOption(this.options.text.message))},a.pandalocker.groups["connect-buttons"]=b}(jQuery);;
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.control);b.tag='<a href="#"></a>',b.setup=function(){var b=this;this.options.actions=this.options.actions||[];var c=!1;for(var d in this.options.actions)"subscribe"===this.options.actions[d]&&(this.options.actions.splice(d,1),c=!0);c&&this.options.actions.push("subscribe"),this.groupOptions.actions&&(this.options.actions=a.extend(this.options.actions,this.groupOptions.actions));for(var e in this.options.actions){var f=a.pandalocker.tools.camelCase(this.options.actions[e]);this.options[f]=this.options[f]||{};var g=f+"Options";this.groupOptions[g]&&(this.options[f]=a.extend(!0,this.options[f],this.groupOptions[g]));var h=f+"ActionOptions";this.lockerOptions[h]&&(this.options[f]=a.extend(!0,this.options[f],this.lockerOptions[h]))}if(this.sdk=this.sdk||this.name,this.options.proxy=this.options.proxy||this.groupOptions.proxy||this.lockerOptions.proxy,c){var i={id:b.locker.id,proxy:b.lockerOptions.proxy,name:b.name,listId:b.options[f].listId,service:b.options[f].service,doubleOptin:b.options[f].doubleOptin,confirm:b.options[f].confirm,requireName:!1},j=new a.pandalocker.services.subscription(i);this.subscriptionService=b.applyFilters("get-default-subscription-service",j)}},b.render=function(b){var c=this;this.control.addClass("onp-sl-button"),this.icon=a("<div class='onp-sl-icon'></div>"),this.icon.appendTo(b),this.container=a("<div class='onp-sl-connect-button onp-sl-social-button-"+this.name+"'></div>"),this.container.appendTo(b),this._hasError()||(this._lockLoadingState(),this.requireSdk(this.sdk,this.options,!1),a.pandalocker.sdk.connect(this.sdk,this.options,function(){c.setupEvents&&c.setupEvents(),c.renderButton(c.container)})),this.handleClick(),this._checkWaitingSubscription()},b.handleClick=function(){var a=this;this.control.click(function(){return a.runHook("raw-interaction"),a._hasError()||a._isLoading()?void 0:(a.connect(function(b,c){a.runActions(b,c)}),!1)})},b._lockLoadingState=function(){this._setLoadingState("connect-button")},b._unlockLoadingState=function(){this._removeLoadingState("connect-button")},b._trackWindow=function(a,b){var c=window.open;window.open=function(d,e,f){var g=c(d,e,f);if(!d)return g;if(-1===d.indexOf(a))return g;var h=setInterval(function(){g&&g.closed===!1||(clearInterval(h),b&&b())},300);return g}},b.runActions=function(b,c){var d=this;if(!this._actionsDone){this._actionsDone=!0;var e=this.options.actions.slice();this.showScreen("data-processing");var f=function(){var g=e.shift();if(!g)return void d.unlock();var h=d.options[a.pandalocker.tools.camelCase(g)],i=a.pandalocker.tools.camelCase("run-"+g+"-action");if(!d[i])throw new Error("The connection action '"+i+"' not found.");d[i](b,c,h,function(a){return"error"===a?(d.runHook("raw-error"),d.showScreen("default")):void f()})};f()}},b.runSubscribeAction=function(b){var c=this,d=function(){c.showScreen("data-processing");var a=c.subscriptionService.subscribe(b);c._setupSubscriptionHooks(a,b)};return b.email?void d():this.showScreen("enter-email",{header:a.pandalocker.lang.connectButtons[c.name].oneStepToComplete||a.pandalocker.lang.connectButtons.oneStepToComplete,message:a.pandalocker.lang.connectButtons[c.name].enterYourEmail||a.pandalocker.lang.connectButtons.enterYourEmail,buttonTitle:a.pandalocker.lang.connectButtons[c.name].doneComplete||a.pandalocker.lang.connectButtons.doneComplete,note:a.pandalocker.lang.connectButtons[c.name].noSpam||a.pandalocker.lang.connectButtons.noSpam,callback:function(a){b.email=a,d()}})},b.runSignupAction=function(b,c,d,e){var f=this,g=function(){var c={};return c.opandaIdentityData=b,c.opandaHandler="signup",c=a.pandalocker.filters.run(f.locker.id+".ajax-data",[c]),c=a.pandalocker.filters.run(f.locker.id+".signup.ajax-data",[c]),a.ajax({type:"POST",dataType:"json",url:f.lockerOptions.proxy,data:c,success:function(){e()},error:function(a){a&&a.readyState<4||(f.showScreen("default"),f.showError("Unable to sign in, the ajax error occurred."),e("error"),console&&console.log&&(console.log("Invalide ajax response:"),console.log(a.responseText)))}})};return b.email?void g():this.showScreen("enter-email",{header:a.pandalocker.lang.connectButtons[f.name].oneStepToComplete||a.pandalocker.lang.connectButtons.oneStepToComplete,message:a.pandalocker.lang.connectButtons[f.name].enterYourEmail||a.pandalocker.lang.connectButtons.enterYourEmail,buttonTitle:a.pandalocker.lang.connectButtons[f.name].doneComplete||a.pandalocker.lang.connectButtons.doneComplete,note:a.pandalocker.lang.connectButtons[f.name].noSpam||a.pandalocker.lang.connectButtons.noSpam,callback:function(a){b.email=a,g()}})},b.connect=function(){throw new Error("The control should implement the method 'connect'")},b._getStorageIdentity=function(){return"opanda_"+a.pandalocker.tools.hash(this.name)+"_hash_"+this.name},a.pandalocker.class.connectButton=b}(jQuery);;
/*!
 * Facebook Connect
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.connectButton);b.name="facebook",b._defaults={},b.prepareOptions=function(){this.permissions=["public_profile"],-1!==a.inArray("subscribe",this.options.actions)&&this.permissions.push("email"),this.restPermissions=this.permissions,this.declinedPermissions=[]},b.renderButton=function(b){var c=this;this.longTitle=a("<span class='onp-sl-long'>"+this.lang.viaFacebookLong+"</span>").appendTo(b),this.shortTtle=a("<span class='onp-sl-short'>"+this.lang.viaFacebookShort+"</span>").appendTo(b);var d=this.groupOptions.loadingTimeout||2e4,e=!1;setTimeout(function(){e||c.showError(a.pandalocker.lang.errors.invlidFacebookAppId)},d),this._getLoginStatus(function(){e=!0,c._unlockLoadingState()})},b.connect=function(b){var c=this;if("connected"===c._status&&!this.restPermissions.length)return this._identify(function(a){b(a,c._serviceData)});var d={scope:c.restPermissions.join(",")};c.declinedPermissions.length>0&&(d.auth_type="rerequest");var e=!1;c._trackWindow("facebook.com/dialog/oauth",function(){setTimeout(function(){e||(c.runHook("raw-social-app-declined"),c.showNotice(a.pandalocker.lang.connectButtons.facebook.notConnected))},500)}),FB.login(function(d){e=!0,c._checkPermissions(d,function(){return"connected"!==c._status?(c.runHook("raw-social-app-declined"),void c.showNotice(a.pandalocker.lang.connectButtons.facebook.notConnected)):c.restPermissions.length?(c.runHook("raw-social-app-declined"),void c.showNotice(a.pandalocker.lang.connectButtons.facebook.notAllPermissionsGranted.replace("{0}",c.restPermissions.join(", ")))):c._identify(function(a){b(a,c._serviceData)})})},d)},b._getLoginStatus=function(a){var b=this;FB.getLoginStatus(function(c){b._checkPermissions(c,a)})},b._checkPermissions=function(b,c){var d=this;return this._status=b.status,this._serviceData=b,b&&"connected"===this._status?void FB.api("/me/permissions",function(b){if(b&&b.data){if(!b.data[0]||b.data[0].permission||b.data[0].status){var e=a.grep(b.data,function(a){return"granted"!==a.status}),f=a.grep(b.data,function(a){return"granted"==a.status});e=a.map(e,function(a){return a.permission}),f=a.map(f,function(a){return a.permission})}else{var f=[],e=[];for(var g in b.data[0])b.data[0][g]?f.push(g):e.push(g)}d.restPermissions=a.pandalocker.tools.diffArrays(d.permissions,f),d.declinedPermissions=a.pandalocker.tools.unionArrays(d.restPermissions,e),c&&c()}}):void(c&&c())},b._identify=function(a){FB.api("/me",function(b){var c={};return b?(c.email=b.email,c.displayName=b.first_name+" "+b.last_name,c.name=b.first_name,c.family=b.last_name,c.gender=b.gender,c.link=b.link,void a(c)):a(c)})},a.pandalocker.controls["connect-buttons"].facebook=b}(jQuery);;
/*!
 * Facebook Connect
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.connectButton);b.name="google",b.sdk="google-client",b._defaults={},b.prepareOptions=function(){return this.options.clientId?(this.permissions=["https://www.googleapis.com/auth/userinfo.profile"],(-1!==a.inArray("subscribe",this.options.actions)||-1!==a.inArray("signup",this.options.actions))&&this.permissions.push("https://www.googleapis.com/auth/userinfo.email"),-1===a.inArray("youtube-subscribe",this.options.actions)||(this.permissions.push("https://www.googleapis.com/auth/youtube"),this.options.youtubeSubscribe&&this.options.youtubeSubscribe.channelId)?(this.restPermissions=this.permissions,void(this.declinedPermissions=[])):this.showError(a.pandalocker.lang.connectButtons.errorYouTubeChannelMissed)):void this.showError(a.pandalocker.lang.connectButtons.google.clientIdMissed)},b.renderButton=function(b){this.longTitle=a("<span class='onp-sl-long'>"+this.lang.viaGoogleLong+"</span>").appendTo(b),this.shortTtle=a("<span class='onp-sl-short'>"+this.lang.viaGoogleShort+"</span>").appendTo(b),this._unlockLoadingState()},b.connect=function(b){var c=this,d=!1,e={callback:function(e){return"immediate_failed"!==e.error?(d=!0,e&&e.status.signed_in?c._identify(function(d,f){return"error"===d?void c.showNotice(a.pandalocker.lang.connectButtons.google.unexpectedError.replace("{0}",f)):void b(f,e)}):(c.runHook("raw-social-app-declined"),void c.showNotice(a.pandalocker.lang.connectButtons.google.notConnected))):void 0}};if(e.clientid=this.options.clientId,e.cookiepolicy="single_host_origin",e.scope=this.permissions.join(" "),this.options.share){var f=a.pandalocker.tools.capitaliseFirstLetter(this.options.share.type||"add");e.requestvisibleactions="http://schema.org/"+f+"Action"}c._trackWindow("google.com/o/oauth2",function(){setTimeout(function(){d||(c.runHook("raw-social-app-declined"),c.showNotice(a.pandalocker.lang.connectButtons.google.notConnected))},500)}),gapi.auth.signIn(e)},b._identify=function(a){gapi.client.load("plus","v1").then(function(){gapi.client.plus.people.get({userId:"me"}).then(function(b){var c={};return b&&b.result?(c.email=b.result.emails&&b.result.emails[0]&&b.result.emails[0].value,c.displayName=b.result.displayName,c.name=b.result.name&&b.result.name.givenName,c.family=b.result.name&&b.result.name.familyName,c.gender=b.result.gender,c.gender=b.result.url,void a("success",c)):a("error",c)},function(b){a("error",b.result.error.message)})})},b.runYoutubeSubscribeAction=function(a,b,c,d){var e=this;gapi.client.load("youtube","v3",function(){var a=gapi.client.youtube.subscriptions.insert({part:"snippet",resource:{snippet:{resourceId:{kind:"youtube#channel",channelId:e.options.youtubeSubscribe.channelId}}}});a.execute(function(a){return a&&a.error?a.error.data&&a.error.data[0]&&"subscriptionDuplicate"===a.error.data[0].reason?void d():(console&&console.log&&console.log(a),e.showError(a.error.message),void d("error")):(e.runHook("got-youtube-subscriber",[a]),void d())})})},a.pandalocker.controls["connect-buttons"].google=b}(jQuery);;
/*!
 * Facebook Twitter
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.connectButton);b.name="twitter",b._defaults={},b.prepareOptions=function(){return this.options.proxy?-1===a.inArray("follow",this.options.actions)||this.options.follow&&this.options.follow.user?-1===a.inArray("tweet",this.options.actions)||this.options.tweet&&this.options.tweet.message?void 0:this.showError(a.pandalocker.lang.connectButtons.errorTwitterMessageMissed):this.showError(a.pandalocker.lang.connectButtons.errorTwitterUserMissed):void this.showError(a.pandalocker.lang.connectButtons.twitter.proxyEmpty)},b.renderButton=function(b){var c=this;this.longTitle=a("<span class='onp-sl-long'>"+this.lang.viaTwitterLong+"</span>").appendTo(b),this.shortTtle=a("<span class='onp-sl-short'>"+this.lang.viaTwitterShort+"</span>").appendTo(b),c._unlockLoadingState()},b.connect=function(b){var c=this;if(a.pandalocker.data.twitterOAuthReady)this._identify(function(a){b(a,c._getServiceData())});else{var d={opandaHandler:"twitter",opandaRequestType:"init",opandaTwitterOptions:JSON.stringify(c.options)},e=a.pandalocker.tools.cookie("opanda_visitor_id");e&&"null"!==e&&(d.opandaVisitorId=e);var f=c.options.proxy;for(var g in d)f=a.pandalocker.tools.updateQueryStringParameter(f,g,d[g]);c._trackWindow("opandaHandler=twitter",function(){setTimeout(function(){a.pandalocker.data.twitterOAuthReady||(c.runHook("raw-social-app-declined"),c.showNotice(a.pandalocker.lang.connectButtons.twitter.notConnected))},500)});{window.open(f,"Twitter Sign-In","width=500,height=450,resizable=yes,scrollbars=yes,status=yes")}window.OPanda_TwitterOAuthCompleted=function(d){a.pandalocker.data.twitterOAuthReady=!0,c._saveVisitorId(d),c.connect(b)},window.OPanda_TwitterOAuthDenied=function(b){c.runHook("raw-social-app-declined"),c.showNotice(a.pandalocker.lang.connectButtons.twitter.notConnected),c._saveVisitorId(b)}}},b._saveVisitorId=function(b){this._visitorId=b,a.pandalocker.tools.cookie("onp_sl_visitor_id",b,{expires:1e3,path:"/"})},b._getServiceData=function(){var a=this;return{visitorId:a._visitorId}},b._identify=function(b){var c=this,d=a.ajax({type:"POST",dataType:"json",url:c.options.proxy,data:{opandaHandler:"twitter",opandaRequestType:"user_info",opandaVisitorId:c._visitorId},success:function(a){var c={};if(!a)return b(c);if(a.name){var d=a.name.split(" ",2);2===d.length?(c.name=d[0],c.family=d[1]):c.name=a.name}else c.name=a.name;c.email=a.email,c.displayName=a.screen_name,c.link="https://twitter.com/"+a.screen_name,b(c)},error:function(){console&&console.log&&console.log("Unable to get the user data: "+d.responseText),b({})}})},b.runFollowAction=function(b,c,d,e){var f=this,g={opandaHandler:"twitter",opandaRequestType:"follow",opandaVisitorId:f._visitorId,opandaFollowTo:d.user,opandaNotifications:d.notifications};g=a.pandalocker.filters.run(f.locker.id+".ajax-data",[g]),g=a.pandalocker.filters.run(f.locker.id+".twitter-follow.ajax-data",[g]);var h=a.ajax({type:"POST",dataType:"json",url:f.options.proxy,data:g});h.success(function(a){return a&&a.error?(f.showScreen("default"),void f.showNotice("Unable to perform the follow action due to the error: "+a.error)):void e()}),h.error(function(){f.showScreen("default"),f.showNotice("Unable to perform the follow action due to the unexpected error. See the logs for more details."),console&&console.log&&console.log("Unable to follow: "+h.responseText)})},b.runTweetAction=function(b,c,d,e){var f=this,g={opandaHandler:"twitter",opandaRequestType:"tweet",opandaVisitorId:f._visitorId,opandaTweetMessage:d.message};g=a.pandalocker.filters.run(f.locker.id+".ajax-data",[g]),g=a.pandalocker.filters.run(f.locker.id+".twitter-tweet.ajax-data",[g]);var h=a.ajax({type:"POST",dataType:"json",url:f.options.proxy,data:g});h.success(function(a){return a&&a.error?(f.showScreen("default"),void f.showNotice("Unable to perform the tweet action due to the error: "+a.error)):void e()}),h.error(function(){f.showScreen("default"),f.showNotice("Unable to perform the tweet action due to the unexpected error. See the logs for more details."),console&&console.log&&console.log("Unable to follow: "+h.responseText)})},a.pandalocker.controls["connect-buttons"].twitter=b}(jQuery);;
/*!
 * Facebook LinkedIn
 * Copyright 2014, OnePress, http://byonepress.com
*/
!function(a){"use strict";var b=a.pandalocker.tools.extend(a.pandalocker.class.connectButton);b.name="linkedin",b.sdk="linkedin-connect",b._defaults={},b.prepareOptions=function(){return this.options.apiKey?-1===a.inArray("follow",this.options.actions)||this.options.follow&&this.options.follow.company?void 0:this.showError(a.pandalocker.lang.connectButtons.errorLinkedInCompanyMissed):void this.showError(a.pandalocker.lang.connectButtons.linkedin.apiKeyMissed)},b.renderButton=function(b){var c=this;this.longTitle=a("<span class='onp-sl-long'>"+this.lang.viaLinkedInLong+"</span>").appendTo(b),this.shortTtle=a("<span class='onp-sl-short'>"+this.lang.viaLinkedInShort+"</span>").appendTo(b),this.permissions=["first-name","last-name","email-address","public-profile-url"];var d=this.groupOptions.loadingTimeout||2e4,e=setInterval(function(){return d-=300,IN.User?(c._unlockLoadingState(),void clearInterval(e)):0>=d?void c.showError(a.pandalocker.lang.connectButtons.linkedin.apiKeyInvalid):void 0},300)},b.connect=function(b){var c=this,d=!1;return IN.User.isAuthorized()?c._identify(function(a){b(a,c._serviceData)}):(c._trackWindow("linkedin.com",function(){setTimeout(function(){d||(c.runHook("raw-social-app-declined"),c.showNotice(a.pandalocker.lang.connectButtons.linkedin.notConnected))},500)}),IN.Event.on(IN,"auth",function(){return d=!0,c._identify(function(a){b(a,c._serviceData)})}),void IN.UI.Authorize().place())},b._identify=function(a){IN.API.Profile("me").fields(this.permissions.join(",")).result(function(b){var c={};return b&&b.values[0]?(c.email=b.values[0].emailAddress,c.displayName=b.values[0].firstName+" "+b.values[0].lastName,c.name=b.values[0].firstName,c.family=b.values[0].lastName,c.link=b.values[0].publicProfileUrl,void a(c)):a(c)})},b.runFollowAction=function(b,c,d,e){var f=this,g=function(a){IN.API.Raw("/people/~/following/companies").method("POST").body('{"id":'+a+"}").result(function(){f.runHook("got-linkedin-follower"),e()}).error(function(a){console&&console.log&&console.log(a),e("error"),e()})};"string"==typeof d.company?IN.API.Raw("/companies/universal-name="+d.company).result(function(a){g(a.id)}).error(function(b){console&&console.log&&console.log(b),f.showError(a.pandalocker.lang.connectButtons.errorLinkedInCompanyNotFound.replace("{0}",d.company)),e("error")}):g(d.company)},a.pandalocker.controls["connect-buttons"].linkedin=b}(jQuery);;
/*!
 * Google Client SDK
 * Copyright 2014, OnePress, http://byonepress.com
*/
...
(function($){
    ...
    window.bizpanda.lockers = function() {
        ...
        $(".onp-optinpanda-call").each(function(){
            var $target = $(this);
    ...
    window.bizpanda.createLocker = function( $target, data, lockId ) {
        ...
        $target.removeClass("onp-optinpanda-call");
...
*/
(function($){ 
    $(function(){ window.bizpanda.lockers(); });
})(jQuery);