...
$optinpandaItem = opanda_fetch_panda_items('optinpanda');
$sociallockerItem = opanda_fetch_panda_items('sociallocker');
?>
...
<div class="onp-help-section">
    ...
    <ul style="margin-bottom: 20px;">
        ...
        <?php if ( !BizPanda::hasPlugin('optinpanda') ) { ?> 
            <li><?php printf( __('Subscribe the user to your mailing list (<a href="%s" target="_blank">Opt-In Panda</a> required)', 'opanda'), $optinpandaItem['url']  ) ?></li>
        <?php } else { ?>
            <li><?php _e('Subscribe the user to your mailing list.', 'opanda') ?></li>
        <?php } ?>
        <?php if ( !BizPanda::hasPlugin('sociallocker') ) { ?> 
            <li><?php printf( __('Publish a tweet from behalf of the user (<a href="%s" target="_blank">Social Locker</a> required)', 'opanda'), $sociallockerItem['url'] ) ?></li>
            <li><?php printf( __('Subscribe the user to your account on Twitter (<a href="%s" target="_blank">Social Locker</a> required)', 'opanda'), $sociallockerItem['url'] ) ?></li>   
            <li><?php printf( __('Subscribe the user to your account on LinkedIn (<a href="%s" target="_blank">Social Locker</a> required)', 'opanda'), $sociallockerItem['url'] ) ?></li>
            <li><?php printf( __('Subscribe the user to your Youtube channel (<a href="%s" target="_blank">Social Locker</a> required)', 'opanda'), $sociallockerItem['url'] ) ?></li>
        <?php } else { ?>
