            ...
            $tabs['items'][] = array(
                ...
                'items'     => array(
                    ...
                    array(
                        ...
                        'way'   => 'buttons',
                        'title' => __('Double Check', 'sociallocker'),
                        'hint'  => __('Optional. Checks whether the user actually has followed you or not. Requires the user to authorize the BizPanda app.', 'sociallocker'),
            ...
            $tabs['items'][] = array(
                ...
                'items'     => array(
                    ...
                    array(
                        'type'  => 'html',
                        'html'  => '<div class="alert alert-warning">'.
                                    __('<strong>Warning:</strong> due to the technical bug on the LinkedIn side, the locked content may be accessible for visitors who close the share dialog without actual sharing.', 'sociallocker')
                                    .'</div>'
                    ),
                    array(
                        'type'  => 'checkbox',
