...
// the notices below is only for the free version return; 
...
function sociallocker_premium_notices( $notices ) {
    ...
    if ( $alreadyActivated ) {
        $message = __('3 extra stunning themes, 7 social buttons, the blurring effect, 8 advanced options, new features & updates every week, dedicated support and more.', 'optinpanda');
        $header = __('Drive more traffic and build quality followers with Opt-In Panda Premium!', 'optinpanda');
        
    } else {
        $message = __('3 extra stunning themes, 7 social buttons, the blurring effect, 8 advanced options, new features & updates every week, dedicated support and more. Drive more traffic and build quality followers with Opt-In Panda Premium!', 'optinpanda');
            ...
            $notices[] = array(
                ...
                'buttons'   => array(
                    array(
                        ...
                        'action'    => onp_licensing_325_get_purchase_url( $sociallocker )
                    ),
                    array(
