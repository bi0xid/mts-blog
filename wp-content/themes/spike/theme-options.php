...
$args['menu_title'] = __('Spike', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Spike', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'sub_desc' => __('Upload your logo <strong>(Recommended height max 90px)</strong> using the Upload Button or insert image URL.', 'nhp-opts')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
					...
					array(
						...
						'type' => 'cats_select',
						'title' => __('Slider Category', 'nhp-opts'), 
					...
					array(
						'id' => 'mts_nav_search_form',
						'type' => 'checkbox',
						'title' => __('Navigation Search Form', 'nhp-opts'),
						'sub_desc' => __('Enable or disable search from in navigation.', 'nhp-opts'),
						'std' => '1'
						),	
					)
				);
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Choose Secondary color fo your theme, this will change default Green color.', 'nhp-opts'),
						'std' => '#FFCA00'
						),
					array(
						'id' => 'mts_layout',
					...
					array(
						...
						'sub_desc' => __('Choose between a <strong>floating or normal</strong> header navigation menu using this option.', 'nhp-opts'),
						'std' => '0'
						),
					array(
						'id' => 'mts_lightbox',
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'options' => array( "Arial" => "Arial", "Arvo" => "Arvo", "Bentham" => "Bentham", "Cantarell" => "Cantarell", "Crimson Text" => "Crimson Text", "Cuprum" => "Cuprum", "Dancing Script" => "Dancing Script", "Droid Sans" => "Droid Sans", "Droid Serif" => "Droid Serif", "Exo" => "Exo", "Goudy Bookletter 1911" => "Goudy Bookletter 1911", "Josefin Sans" => "Josefin Sans", "Kreon" => "Kreon", "Lobster" => "Lobster", "Monda" => "Monda", "Nobile" => "Nobile", "Open Sans" => "Open Sans", "Patua One" => "Patua One", "PT Sans" => "PT Sans", "Philosopher" => "Philosopher", "Quattrocento" => "Quattrocento", "Raleway" => "Raleway", "Signika" => "Signika", "Sintony" => "Sintony", "Tangerine" => "Tangerine", "Ubuntu" => "Ubuntu", "Yanone Kaffeesatz" => "Yanone Kaffeesatz", "Quando" => "Quando"),
						'std' => 'Monda'
						),
					array(
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'mts_social_buttons_home',
						'type' => 'button_set',
						'title' => __('Social media buttons on Homepage', 'nhp-opts'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Check this box to show social sharing buttons on homepage.', 'nhp-opts'),
						'std' => '1'
						),
					array(
						'id' => 'mts_twitter',
