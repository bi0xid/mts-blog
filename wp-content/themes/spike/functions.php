...
function mts_add_scripts() {
	...
	wp_enqueue_script( 'main-js', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '1.0.6', true );
...
function mts_enqueue_css() {
	...
	wp_enqueue_style('custom-style', get_template_directory_uri() . '/css/style.css', 'style', '1.0.7');
}
