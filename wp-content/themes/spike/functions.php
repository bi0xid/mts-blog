...
function mts_enqueue_css() {
	...
	wp_enqueue_style('custom-style', get_template_directory_uri() . '/css/style.css', 'style', '1.0.3');
}
...
// Update social shares (msp-plugin)
add_action( 'init', 'get_post_facebook_shares' );

function get_post_facebook_shares() {
