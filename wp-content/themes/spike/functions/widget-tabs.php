...
<div class="clear"></div>
	 ...
	 <!--end .entry-meta-->
    <span class="tab_meta"><span><?php the_time('F, d Y'); ?> </span> - <span><a href="<?php comments_link(); ?>" rel="nofollow"><?php comments_number('0 Comment','1 Comment','% Comments'); ?></a></span></span>
	</div> <!--end .info-->
	<div class="clear"></div>
</li>
